...
var Qed = {
    ...
    httpGET: function(reqParams) {
        return Qed._httpReq("GET", reqParams);
    },
    httpPOST: function(reqParams, data) {
        return Qed._httpReq("POST", reqParams, data);
    },
    httpsHEAD: function(reqParams) {
        return Qed._httpsReq("HEAD", reqParams);
    },
    httpsGET: function(reqParams) {
        return Qed._httpsReq("GET", reqParams);
    },
    httpsPOST: function(reqParams, data) {
        return Qed._httpsReq("POST", reqParams, data);
    },
    httpsPUT: function(reqParams, data) {
        return Qed._httpsReq("PUT", reqParams, data);
    },
    _httpReq: function(method, reqParams, data) {
    ...
    _httpsReq: function(method, reqParams, data) {
        var deferred = Q.defer();
    ...
    tryPromise: function(f, args, maxTries, delay) {
        return Q.fapply(f, args).catch(function(err) {
            Qed.logger.warn("Error occured", err);
            if (maxTries || maxTries === 0) {
                Qed.logger.warn("Left attempts : " + maxTries);
            } else {
                Qed.logger.warn("Retrying...");
            }
